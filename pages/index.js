      ...
      <div className="max-w-md p-8 mx-auto rounded-lg bg-coolGray-50 text-coolGray-800">
        <div className="flex justify-between space-x-8">
          <div className="flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-24 h-24 p-2 text-yellow-400 fillCurrent">
        ...
        <div className="flex justify-between mt-8 space-x-4 text-coolGray-600">
